    ...
    <ThemeProvider>
      <div className="w-full h-screen flex flex-col lg:flex-row bg-white dark:bg-gray-950">
        ...
        <div className="w-full lg:w-1/2 flex items-center justify-center p-6 lg:p-12 bg-white dark:bg-gray-950 relative overflow-hidden">
          {/* Detalles decorativos sutiles en mobile */}
          <div className="absolute inset-0 pointer-events-none overflow-hidden">
            <div className="absolute top-0 right-0 w-96 h-96 bg-gradient-to-bl from-brand-100 dark:from-brand-950/20 rounded-full blur-3xl opacity-30"></div>
            <div className="absolute -bottom-32 -left-32 w-80 h-80 bg-gradient-to-tr from-brand-100 dark:from-brand-950/20 rounded-full blur-3xl opacity-20"></div>
          </div>
