// src/components/attendance/components/attendance-header/AttendanceHeader.tsx
"use client";
...
export default function AttendanceHeader({
  ...
  // 🔄 Datos automáticos de contextos
  const { cycle: activeCycle, isActive: hasCycle } = useCurrentSchoolCycle();
  const { bimester: activeBimester, isActive: hasBimester, progress, daysRemaining } = useCurrentBimester();
