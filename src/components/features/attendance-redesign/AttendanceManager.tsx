/**
 * src/components/features/attendance-redesign/AttendanceManager.tsx
 * ✅ VERSIÓN REDISEÑADA - Basada en diseño modular
 *
...
import {
  LoadingState,
  NoSectionsState,
} from "./components/states/EmptyAndLoadingStates";
...
export default function AttendanceManager() {
  ...
  const attendancePermission = user?.role?.permissions?.find(
    (p: any) => p.permission?.module === "attendance"
  );
  ...
  // ============================================
  // Procesar secciones según scope
  // ============================================
      ...
      <div className="max-w-7xl mx-auto px-4 py-8">
        ...
        <div className="space-y-4">
          {visibleSections.map((section: Section) => {
            ...
            const selectedCourseObjects = section.courses.filter((c: any) =>
            ...
            return (
              <SectionCard
                ...
                onToggleCourse={(courseId: number) =>
