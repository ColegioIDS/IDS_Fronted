...
import { Avatar } from "../ui/avatardicebear";
  ...
  >
    ...
    >
      <path
        fillRule="evenodd"
        clipRule="evenodd"
        d="M15.3 8.7C15.69 8.31 15.69 7.68 15.3 7.29C14.91 6.9 14.28 6.9 13.89 7.29L9.59 11.59C9.21 11.97 9.21 12.6 9.59 12.99L13.89 17.29C14.28 17.68 14.91 17.68 15.3 17.29C15.69 16.9 15.69 16.27 15.3 15.88L12.41 13H20C20.55 13 21 12.55 21 12C21 11.45 20.55 11 20 11H12.41L15.3 8.7ZM3 5C3 3.9 3.9 3 5 3H11C11.55 3 12 3.45 12 4C12 4.55 11.55 5 11 5H5V19H11C11.55 19 12 19.45 12 20C12 20.55 11.55 21 11 21H5C3.9 21 3 20.1 3 19V5Z"
        fill="currentColor"
      />
    </svg>
    Cerrar sesión
