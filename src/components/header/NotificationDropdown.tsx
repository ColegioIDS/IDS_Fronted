              ...
              <li key={notification.id}>
                ...
                >
                  ...
                  <span className="block flex-1">
                    <span className="mb-1.5 block text-theme-sm text-gray-800 font-medium dark:text-white/90">
                      {notification.title}
                    </span>
                  ...
                  {notification.status !== "READ" && (
                    <span className="block w-2 h-2 mt-2 rounded-full bg-blue-500 flex-shrink-0"></span>
                  )}
                </button>
              </li>
            ))}
