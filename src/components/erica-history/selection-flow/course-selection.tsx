// src/components/erica-history/selection-flow/course-selection.tsx
"use client";
...
import { BookOpen, User2, Users, Palette, AlertCircle, CheckCircle2, History, BarChart3 } from 'lucide-react';
...
export default function CourseSelection({
    ...
    return (
      <div className="space-y-4">
        <div className="flex items-center gap-2 text-sm text-gray-600 dark:text-gray-400 mb-4">
          ...
          <span>Cargando historial de cursos de {selectedTeacher.givenNames} {selectedTeacher.lastNames}...</span>
        </div>
    ...
    return (
      <div className="text-center py-12">
        ...
        <h3 className="text-lg font-medium text-gray-900 dark:text-gray-100 mb-2">
          Sin cursos con historial
        </h3>
        <p className="text-gray-600 dark:text-gray-400 mb-4 max-w-md mx-auto">
          {selectedTeacher.givenNames} {selectedTeacher.lastNames} no tiene cursos asignados 
          en la sección {selectedSection.name} o no hay evaluaciones registradas.
        </p>
          ...
          <div className="flex items-start gap-3">
            ...
            <div className="text-sm text-blue-800 dark:text-blue-200">
              ...
              <ul className="space-y-1 text-blue-700 dark:text-blue-300">
                ...
                <li>• Asegurar que hay evaluaciones ERICA registradas</li>
              </ul>
            </div>
          </div>
        </div>
  ...
  const CourseCard = ({ course, index }: { course: CourseWithAssignment, index: number }) => (
    <Card 
      className="cursor-pointer transition-all duration-200 hover:shadow-md hover:scale-[1.02] border-2 border-emerald-200 dark:border-emerald-800 bg-emerald-50/50 dark:bg-emerald-950/30 hover:border-emerald-300 dark:hover:border-emerald-600"
        ...
        <div className="space-y-3">
          ...
          <div className="space-y-2">
            ...
            <div className="flex gap-2 flex-wrap">
              ...
              <Badge variant="outline" className="text-xs text-emerald-600 dark:text-emerald-400 bg-emerald-50 dark:bg-emerald-900/30">
                Con historial
              </Badge>
            </div>
            ...
            <div className="flex items-center gap-2 text-xs text-emerald-600 dark:text-emerald-400">
              ...
              <span>Evaluaciones ERICA registradas</span>
            </div>
          </div>
          ...
          <div className="flex items-center justify-between pt-2 border-t border-gray-200 dark:border-gray-700">
            <span className="text-xs text-gray-500 dark:text-gray-400">
              Click para consultar historial
            </span>
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex items-center gap-2 text-sm text-gray-600 dark:text-gray-400 mb-4">
        <User2 className="h-4 w-4" />
        <span>
          Historial de cursos de <span className="font-medium">
      ...
      {(titularCourses.length > 0 || specialistCourses.length > 0) && (
        <div className="bg-emerald-50 dark:bg-emerald-900/20 border border-emerald-200 dark:border-emerald-800 rounded-lg p-4">
          <div className="flex items-start gap-3">
            <BarChart3 className="h-5 w-5 text-emerald-600 dark:text-emerald-400 mt-0.5" />
            <div className="text-sm">
              <div className="font-medium text-emerald-800 dark:text-emerald-200 mb-2">
                Historial QNA por tipo de asignación:
              </div>
              <div className="space-y-2 text-emerald-700 dark:text-emerald-300">
                <div className="flex gap-2">
                  <Badge variant="default" className="text-xs">Titular</Badge>
                  <span>Profesor responsable principal - acceso completo al historial</span>
                </div>
                <div className="flex gap-2">
                  <Badge variant="secondary" className="text-xs">Especialista</Badge>
                  <span>Profesor de apoyo especializado - historial por materia específica</span>
                </div>
                <div className="mt-3 p-2 bg-emerald-100 dark:bg-emerald-900/40 rounded text-xs">
                  <strong>Nota:</strong> El historial QNA muestra todos los cálculos automáticos (QNA1, QNA2, promedios mensuales) 
                  basados en las evaluaciones ERICA previamente registradas.
                </div>
              </div>
            </div>
          </div>
