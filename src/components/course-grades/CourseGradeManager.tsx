...
import { Plus, Download, FileSpreadsheet, Filter, BarChart3, Pencil } from 'lucide-react';
...
import { CourseGradeWithRelations, CourseGradeFilters as FilterType } from '@/types/course-grade.types';
import { toast } from 'sonner';

/**
 * Enhanced main container component for managing course-grade relationships
 * Features: advanced filtering, pagination, statistics, improved UI
 */
export function CourseGradeManager() {
  ...
  totalFiltered: filtered.length, // Agregar esta línea
  ...
  const handleFormSubmit = async (data: any) => {
    try {
      if (editingId) {
        await updateCourseGrade(editingId, data);
      } else {
